...
export VSCODE_CLI_DOWNLOAD_URL="https://github.com/VaultAI-EU/void/releases"
export VSCODE_CLI_QUALITY="stable"
export VSCODE_CLI_UPDATE_URL="https://raw.githubusercontent.com/VaultAI-EU/versions/refs/heads/main"
...
# export VSCODE_CLI_DOWNLOAD_URL="https://github.com/VaultAI-EU/void-insiders/releases"
