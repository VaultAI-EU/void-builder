...
if [[ "${OS_NAME}" == "linux" ]]; then
  ...
  # control.template
  sed -i 's|Microsoft Corporation <vscode-linux@microsoft.com>|Void Team <team@VaultAI-EU.com>|'  resources/linux/debian/control.template
  ...
  sed -i 's|Visual Studio Code Team <vscode-linux@microsoft.com>|Void Team <team@VaultAI-EU.com>|' resources/linux/rpm/code.spec.template
