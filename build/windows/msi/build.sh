...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Vault Code - Insiders"
  PRODUCT_CODE="VaultCodeInsiders"
  ...
  PRODUCT_NAME="Vault Code"
  PRODUCT_CODE="VaultCode"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="VaultCode-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="VaultCode-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
