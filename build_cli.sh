...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/VaultAI-EU/versions/refs/heads/main" # Void

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/VaultAI-EU/void-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/VaultAI-EU/void/releases" # Void
fi
